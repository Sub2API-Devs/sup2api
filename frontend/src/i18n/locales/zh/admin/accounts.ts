    ...
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc:
          '多人共享同一 OAuth 账号时，将各用户的设备/会话/线程标识收敛为账号级恒定值。默认线程池把根线程压到最多 4 条；若客户端带了子代理/fork 谱系，每个根线程再挂 1 条 child（上限约 8）。关闭时原样透传客户端标识。',
        codexFingerprintOff: '关闭（透传）',
        codexFingerprintDevice: '仅设备',
        codexFingerprintSession: '设备+会话（已按线程池封顶）',
        codexFingerprintThreadPool: '设备+会话+线程池（推荐）',
        codexFingerprintFull: '完全收敛（单根线程）',
