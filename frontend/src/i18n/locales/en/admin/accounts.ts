    ...
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc:
          'When multiple users share the same OAuth account, converge device/session/thread identifiers to account-level stable values. The default thread pool caps root threads at 4; a client subagent/fork adds one child per root (about 8 max). Off = pass through client identifiers as-is.',
        codexFingerprintOff: 'Off (passthrough)',
        codexFingerprintDevice: 'Device only',
        codexFingerprintSession: 'Device + Session (capped like thread pool)',
        codexFingerprintThreadPool: 'Device + Session + Thread pool (recommended)',
        codexFingerprintFull: 'Full convergence (single root thread)',
