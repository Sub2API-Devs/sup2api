export default {
    accounts: {
      ...
      accountLocation: 'Account storage location',
      mainServerAccounts: 'Main server accounts',
      workerAccounts: 'Worker accounts',
      workerLabel: 'Worker ·',
      searchWorkerAccounts: 'Search Worker accounts...',
      allWorkers: 'All Workers',
      allWorkersCount: 'All Workers ({count})',
      workerFilter: 'Filter accounts by Worker',
      workerAccountCount: '{count} accounts',
      workerCapacityManaged: 'Worker managed',
      workerSchedulingHint: 'Scheduling for this account is managed by its Worker',
      workerUsageUnavailable: 'Usage windows are not reported by this Worker',
      lastTest: 'Last test',
      editWorkerAccount: 'Edit Worker Account',
      workerTestModel: 'Test model',
      workerEditCredentialHint: 'Editing updates metadata only and never reads or replaces credentials stored on the Worker.',
      workerAccountUpdated: 'Worker account updated',
      workerAccountUpdateFailed: 'Failed to update Worker account',
      workerPartialLoadFailed: '{count} Worker(s) could not be synchronized. Accounts from the remaining Workers are shown.',
      noWorkerAccounts: 'No Worker accounts',
      noWorkerAccountsHint: 'Choose a target Worker when adding an account. It will remain manageable here after creation.',
      allModels: 'All models',
      refreshWorkerCredential: 'Refresh the credential inside the Worker',
      testWorkerAccount: 'Test the account inside the Worker',
      test: 'Test',
      deleteWorkerAccount: 'Delete Worker account',
      deleteWorkerAccountConfirm: 'Delete Worker account "{name}"? This permanently removes the real credential stored on the Worker.',
      workerAccountsLoadFailed: 'Failed to load Worker accounts',
      workerCredentialRefreshed: 'Worker account credential refreshed',
      workerCredentialRefreshFailed: 'Failed to refresh Worker account credential',
      workerAccountTestPassed: 'Worker account test passed',
      workerAccountTestFailed: 'Worker account test failed',
      workerTestOwner: 'Owned by {name}',
      workerTestOwnerLine: 'Worker: {worker}',
      workerTestModelUnavailable: 'No testable model is configured for this Worker account. Add one in Edit first.',
      workerTestHttpStatus: 'HTTP status: {status}',
      workerTestLatency: 'Latency: {latency} ms',
      workerTestEmptyResponse: 'The upstream returned an empty response body',
      workerAccountDeleted: 'Worker account deleted',
      workerAccountDeleteFailed: 'Failed to delete Worker account',
      ...
      openai: {
        ...
        codexFingerprintThreadPool: 'Device + Session + Thread pool (recommended)',
      ...
      accountCreatedOnWorker: 'Account created on the Worker',
      addToWorkerHint: 'When a Worker is selected, credentials stay on that Worker and are not stored in the control plane. API key accounts are supported here; complete OAuth from Worker management.',
      workerAccountUnsupported: 'This account type cannot be written to a Worker from this form. Use Worker management or clear the Worker target.',
      workerAccountKeyRequired: 'An API key is required to add this account to a Worker',
      workerOAuthUnsupported: 'Add OAuth accounts from Worker management, or clear “Add to Worker” to create them locally.',
