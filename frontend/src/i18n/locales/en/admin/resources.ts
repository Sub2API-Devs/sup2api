export default {
    ...
    proxies: {
      ...
      addToWorkerHint: 'When selected, the proxy is stored only on that Worker.',
      addedToWorker: 'Proxy added to the Worker',
      addToWorkerFailed: 'Failed to add the proxy to the Worker',
