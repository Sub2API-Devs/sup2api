...
// precedes data_plane_id and created_at.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 60, "arg-type table must include the merged usage-log columns")
	...
	// created_at is last and data_plane_id is penultimate.
